...
public class FlowContractPayListAdapter extends RecyclerView.Adapter<FlowContractPayListAdapter.ViewHolder> {
    ...
    @Override
    public FlowContractPayListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(FlowContractPayListAdapter.ViewHolder holder, int position) {
