...
public class MyFlowListAdapter extends RecyclerView.Adapter<MyFlowListAdapter.ViewHolder> {
    ...
    @Override
    public MyFlowListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MyFlowListAdapter.ViewHolder holder, int position) {
