...
public class JianChaRenAdapter extends RecyclerView.Adapter<JianChaRenAdapter.ViewHolder> {
    ...
    @Override
    public JianChaRenAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(JianChaRenAdapter.ViewHolder holder, final int position) {
