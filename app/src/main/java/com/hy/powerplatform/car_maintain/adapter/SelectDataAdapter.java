...
public class SelectDataAdapter extends RecyclerView.Adapter<SelectDataAdapter.ViewHolder> {
    ...
    @Override
    public SelectDataAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SelectDataAdapter.ViewHolder holder, final int position) {
