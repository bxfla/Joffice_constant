...
public class CarNoAdapter extends RecyclerView.Adapter<CarNoAdapter.ViewHolder> {
    ...
    @Override
    public CarNoAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CarNoAdapter.ViewHolder holder, final int position) {
